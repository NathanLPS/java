...
public class PlanoSaudeV2 {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			break;
		case 2:
			System.out.printf("\n%s o o seu plano de saúde custará R$ 200,00 por mês.", nome);
			break;
		case 3:
			System.out.printf("\n%s o o seu plano de saúde custará R$ 300,00 por mês.", nome);
			break;
		case 4: 
			System.out.printf("\n%s o o seu plano de saúde custará R$ 500,00 por mês.", nome);
			break;
		case 5:
			System.out.printf("\n%s o o seu plano de saúde custará R$ 600,00 por mês.", nome);
			break;
		case 6: 
			System.out.printf("\n%s o seu plano de saúde custará R$ 1000,00 por mês.", nome);
			break;
		default:
			System.out.println("Faixa Etária invàlida!");
		}
